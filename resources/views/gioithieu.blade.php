...
<header class="site-header size-lg text-center" style="height: 400px;background-image: url({{ URL::asset('public/img/gioithieu/gioithieu.jpg') }})">
...
<div id="about" class="container fill">
    ...
    <div class="row" id="about_detail">
        ...
        <div class="detail-label-2"><label style="margin: 0"><h4 style="margin: 0">SỨ MỆNH</h4></label></div>
        <div class="detail-param">
        ...
        <div class="detail-label-2"><label style="margin: 0"><h4 style="margin: 0">TẦM NHÌN</h4></label></div>
        <div class="detail-param">
        ...
        <div class="detail-label-2"><label style="margin: 0"><h4 style="margin: 0">DỊCH VỤ VỆ SINH HÀNG NGÀY</h4></label></div>
        <div class="detail-param">
            ...
            <ul style="list-style-type: circle;padding-left: 30px">
                <li><span>Vệ sinh văn phòng</span></li>
                <li><span>Vệ sinh khách sạn</span></li>
                <li><span>Vệ sinh nhà máy</span></li>
                <li><span>Vệ sinh toà nhà</span></li>
                <li><span>Vệ sinh bệnh viện</span></li>
            </ul>
        </div>
    </div>
</div>
